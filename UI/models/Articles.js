...
Articles.prototype.getAll = function() {
	...
	var that = this;
	var config = {
		url: "https://web9-iraresrazvan.c9users.io/curs21-PHP-API/articles",
		method: "GET",
...
Articles.prototype.save = function(articleData) {
	...
	// https://web9-iraresrazvan.c9users.io/articles/add
	// POST
	...
	var config = {
		url: "https://web9-iraresrazvan.c9users.io/curs21-PHP-API/articles/add",
		method: "POST",
		data: formData,
